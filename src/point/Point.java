...
public class Point {
    ...
    public double distance(){         //return the distance between this Point and Point 0,0 as double
        int xDistance = 0;
        int yDistance = 0;

        int distance;
        distance = (x - xDistance) * (x - xDistance) + (y - yDistance) * (y - yDistance);
    ...
    public  double distance (Point another){
        ...
        double distance;
        distance = Math.sqrt((this.x - xAnother) * (this.x - xAnother) + (this.y - yAnother) * (this.y - yAnother));
        return distance;
    }
}
